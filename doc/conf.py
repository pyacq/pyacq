# -*- coding: utf-8 -*-
#
# pyacq documentation build configuration file, created by
# sphinx-quickstart on Sun Dec  6 21:31:01 2015.
#
...
exclude_patterns = ['_build', 'numpydoc-0.5']
...
latex_documents = [
  ('index', 'pyacq.tex', u'pyacq Documentation',
   u'Samuel Garcia, Alexandra Corneyllie, Luke Campagnola', 'manual'),
]
...
man_pages = [
    ('index', 'pyacq', u'pyacq Documentation',
     [u'Samuel Garcia, Alexandra Corneyllie, Luke Campagnola'], 1)
]
...
texinfo_documents = [
  ('index', 'pyacq', u'pyacq Documentation',
   u'Samuel Garcia, Alexandra Corneyllie, Luke Campagnola', 'pyacq', 'One line description of project.',
   'Miscellaneous'),
]
